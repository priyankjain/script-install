...
*/					
					$main_folder = str_replace('pdf.php','',str_replace('pdf_invoice.php','',str_replace('\\','/',getenv('SCRIPT_FILENAME'))));
					if ($tag['attribute']['src']=='logo.png') $tag['attribute']['src'] = $main_folder."pdf/logo.png";
//					$tag['attribute']['src'] = str_replace('pdf.php','',getenv('SCRIPT_FILENAME')).'pdf/'.$tag['attribute']['src'];
//					$tag['attribute']['src'] = str_replace('pdf_invoice.php','',$tag['attribute']['src']);
